...
public class SendMail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String tokenn = String.valueOf(session.getAttribute("token"));

		// on utilise la fonction qui va recuperer le cookie
		String cookie = GetCookie.recupererCookie(request, tokenn);
		if (cookie.equals(tokenn)) {
			...
			if (request.getParameter("nom") != null) {
				...
				String message1 = "<!DOCTYPE html>\r\n"
						...
						+ "																		<p style=\"margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 61.2px;\"><span style=\"font-size:34px;\"><span style=\"font-size:34px;\">Cher </span><strong><span style=\"font-size:34px;\"><span style=\"font-size:34px;background-color:#ffffff;\"><span style=\"color:#003300;font-size:34px;background-color:#ffffff;\">&nbsp;<span style=\"color:#008000;font-size:34px;\">"
						+ prenom + "</span>&nbsp;</span></span>,&nbsp;</span></strong></span></p>\r\n"
						...
						+ "																		<p style=\"margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;\"><span style=\"color:#999999;font-size:14px;\">Facture : "
						+ token + " </span>&nbsp;</p>\r\n"
						+ "																	</div>\r\n"
						+ "																</div>\r\n"
						+ "															</td>\r\n"
						...
						+ "																<div style=\"font-family: sans-serif\">\r\n"
						+ "																	<div class style=\"font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Oxygen, Trebuchet MS, Helvetica, sans-serif;\">\r\n"
						+ "																		<p style=\"margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;\"><span style=\"color:#999999;font-size:14px;\">Créé le : "
						+ datetime + " </span>&nbsp;</p>\r\n"
						+ "																	</div>\r\n"
						+ "																</div>\r\n"
						+ "															</td>\r\n"
						...
						+ "																<div style=\"font-family: sans-serif\">\r\n"
						+ "																	<div class style=\"font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #FFFFFF; line-height: 1.2; font-family: Oxygen, Trebuchet MS, Helvetica, sans-serif;\">\r\n"
						+ "																		<p style=\"margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;\"><span style=\"font-size:18px;\"><strong>"
						+ apayer + " €&nbsp;</strong></span></p>\r\n"
						+ "																	</div>\r\n"
						+ "																</div>\r\n"
						+ "															</td>\r\n"
						+ "														</tr>\r\n"
						...
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Client : "
						+ nom + " " + prenom + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Adresse : "
						+ adresse + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Mail : "
						+ email + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Numéro de téléphone : "
						+ telephone + "</p>\r\n"
						+ "																	</div>\r\n"
						+ "																</div>\r\n"
						+ "															</td>\r\n"
						...
						+ "																<div style=\"font-family: sans-serif\">\r\n"
						+ "																	<div class style=\"font-size: 12px; mso-line-height-alt: 18px; color: #555555; line-height: 1.5; font-family: Oxygen, Trebuchet MS, Helvetica, sans-serif;\">\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Entreprise : "
						+ prenom_user + " " + nom_user + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Adresse : "
						+ adresse_user + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Mail: "
						+ mail_user + "</p>\r\n"
						+ "																		<p style=\"margin: 0; font-size: 12px; mso-line-height-alt: 18px;\">Détail des heures ici : <a href=\""
						+ contextPath + "/DetailsHeures?facture=" + token + "\">Lien heures ici</a></p>\r\n"
						+ "																	</div>\r\n"
						+ "																</div>\r\n"
						+ "															</td>\r\n"
						+ "														</tr>\r\n"
