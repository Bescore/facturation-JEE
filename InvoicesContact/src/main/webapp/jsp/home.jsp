	...
	<div class="page-flex">
		...
		<main class="main users chart-page" id="skip-target">
			<form method="post">
				<div class="container">
					<c:if
						test="${empty clients && empty types || empty clients|| empty types}">
						<h2 class="main-title my-4">Bonjour !</h2>
						<div class="row mx-auto">
							<div class="col-12 col-xl my-2 ">
								<div class="card ">
									<div class="card-body ">
										<h6 class="my-2 text-center fw-bold">1 . Ajoutez des
											clients</h6>
							...
							<div class="row mx-auto">
								<div class="col-12 col-xl my-2 ">
									...
									<div class="card text-center ">
										<div class="card-body rounded-3">
											<h5>
												<i class="fa-solid fa-stopwatch fa-2x text-primary"
													title="Durée"></i>
											</h5>
											<div class="my-2">
												<c:out value=" ${activites_recentes.duree_activite } (H)"></c:out>
											</div>
								...
								<div class="col-12 col-xl my-2 ">
									...
									<div class="card text-center">
										<div class="card-body ">
											<h5>
												<i class="fa-solid fa-briefcase fa-2x text-warning"
													title="Client et mission"></i>
											</h5>
											<div class="my-2">
												<c:out
													value=" ${activites_recentes.client.prenom } ${activites_recentes.client.nom }"></c:out>
												--
												<c:out value=" ${activites_recentes.type.type_mission }"></c:out>
												--
												<c:out value=" ${activites_recentes.tarif } €/heures"></c:out>
											</div>
										</div>
									</div>
								</div>
								<div class="col-12 col-xl my-2 ">
									...
									<div class="card text-center ">
										<div class="card-body ">
											<h5>
												<i class="fa-solid fa-sack-dollar fa-2x text-success"
													title="Argent gagné"></i>
											</h5>
											<div class="my-2">
												<c:out value=" ${somme_du} € (brut)"></c:out>
											</div>
										</div>
									</div>
								</div>
